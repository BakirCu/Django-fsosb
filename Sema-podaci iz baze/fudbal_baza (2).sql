...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$150000$vjmyued4ZFfK$9LnshH7wHb6RlpxMM7ApQtQmenymaVdLlR3hO8ksTUU=','2019-10-22 12:28:37.197299',1,'bakir','','','',1,1,'2019-10-06 19:54:35.724568');
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(7,'fudbal','delegat'),(8,'fudbal','sudija'),(9,'fudbal','tim'),(10,'fudbal','utakmica'),(6,'sessions','session'),(12,'vesti','gallery'),(13,'vesti','slika'),(11,'vesti','vesti');
...
INSERT INTO `fudbal_delegat` VALUES (1,'bakir','curic'),(2,'nemanja','mijailovic'),(3,'milica','miljkov'),(4,'amra','curic'),(5,'timur','curic'),(6,'daris','dolovac'),(7,'Miki','Markovic');
...
INSERT INTO `fudbal_sudija` VALUES (1,'bakir','mijailovic'),(2,'nemanja','curic'),(3,'milica','curic'),(4,'timur','mijailovic'),(5,'amra','mijailovic'),(6,'bakir','curic'),(7,'nemanja','mijailovic'),(8,'amra','curic'),(9,'milica','miljkov'),(10,'Bakir','car'),(11,'Faruk        Gil','Razdaginac'),(12,'Sasdassdsadas','Asd          Fsd');
...
INSERT INTO `vesti_slika` VALUES (2,'Milica','2019-10-29 17:12:22.000000','galerija_img/20190509_115719.jpg'),(3,'Nesto','2019-10-29 17:12:31.000000','galerija_img/blob.png');
/*!40000 ALTER TABLE `vesti_slika` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `vesti_vesti`
--

DROP TABLE IF EXISTS `vesti_vesti`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `vesti_vesti` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `naslov` varchar(100) NOT NULL,
...
--
-- Dumping data for table `vesti_vesti`
--

LOCK TABLES `vesti_vesti` WRITE;
/*!40000 ALTER TABLE `vesti_vesti` DISABLE KEYS */;
INSERT INTO `vesti_vesti` VALUES (21,'Nemanja','cfsdfds','2019-10-29 17:13:01.000000','vesti_img/git.jpg','https://www.youtube.com/embed/'),(22,'Amra','dsadasd','2019-10-29 17:17:47.000000','vesti_img/liga_rezultati.jpg','https://www.youtube.com/embed/'),(23,'Amra','kjkljkljkl','2019-10-29 17:18:08.000000','vesti_img/20190509_121044.jpg','https://www.youtube.com/embed/');
/*!40000 ALTER TABLE `vesti_vesti` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-10-30 13:01:50
